...
PAPER:
    Lee, J-H. (2025). "Proactive Latency Control: A Mechanism-Robust Framework for LEO Handovers and Per-Flow Queueing Environments"
...
CITATION:
    ...
    @article{lee2025plc,
      title={Proactive Latency Control: A Mechanism-Robust Framework for  
             LEO Handovers and Per-Flow Queueing Environments},
